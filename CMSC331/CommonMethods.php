...
{	
  ...
  {
    $this->debug = $debug; 
    $rs = $this->connect("klau4");
    //    $rs = $this->connect("Proj2Advisors"); // db name really here   (CHANGED FROM jeanice1)
  ...
  function connect($db)// connect to MySQL
  {
    ...
    $conn = @mysql_connect("studentdb-maria.gl.umbc.edu", "klau4", "Gu7+!Z*GGMRe=d*Z") or die("<br> Could not connect to MySQL <br>");

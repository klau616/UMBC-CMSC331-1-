...
<html lang="en">
    ...
    </head> <!--reference to css for user interface-->
    <body>
    <div id="login">
    <div id="form">
    <div class="top">
...
<div class="selections">
    ...
    <?php
    $debug = false;
include('../CommonMethods.php');   //links back to commonMethod
...
$sql = "select * from Proj2Students where `StudentID` = '$studid'"; //links to student database 
...
if ($_SESSION["studExist"] == false || $adminCancel == true || $noApp == true){  //menu for general information
  if($adminCancel == true){
...
<form action="Logout.php" method="post" name="Logout">  <!--closes all applications for website-->

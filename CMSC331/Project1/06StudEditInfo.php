...
$sql = "select * from Proj2Students"; //access info from student data base
    ...
    <div id="login">
      <div id="form">
			...
			<div class="field">
				  ...
				  <select id="major" name = "major">//changing major from drag drop menu
...
-->
			...
			<div class="nextButton">
				<input type="submit" name="save" class="button large go" value="Save"> <!--submit button for submitting changes-->
			</div>
																	  
																	 <!-- <form method="link" action="12StudExit.php">
																
																	  <input type="submit" name="cancel" class="button large" value="Cancel">

...
<html lang="en"> <!--styling for this page since it wasnt included in the standard.css-->
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div id="login">
      <div id="form">
	    ...
	    <div class="field">                                 <!--selection for appointment time-->
		<form action="11StudSearchResult.php" method="post" name="SearchApp">
			<label for="date">Date</label> 
	      	<input id="date" type="date" name="date" placeholder="mm/dd/yyyy" autofocus> (mm/dd/yyyy)
					                                 <!--provides the user with checkbox formats for time selection-->
			...
			<label for="advisor">Advisor</label>
					       <select id="advisor" name="advisor">    <!-- Drop down menu for list of advisors-->
	    ...
	    <div class="nextButton">                    <!--proceed to next page-->
			<input type="submit" name="go" class="button large go" value="Go">
	    </div>
		</div>
			    </form>                <!--access back to homepage-->

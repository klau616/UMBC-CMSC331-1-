...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Exit Message</title> <!--styling reference-->
  ...
  <body>
    <div id="login">
      <div id="form">
        <div class="top">
	    <div class="statusMessage"> <!--prompts user if scheduling was not available-->
	    ...
	    <div class="returnButton"> <!-- returns to homepage-->

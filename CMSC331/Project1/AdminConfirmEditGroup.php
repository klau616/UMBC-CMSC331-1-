...
<html lang="en">
  ...
  //links back to css file for styling purpose
  </head>
  <body>
    <div id="login">
      <div id="form">
...
if($delete == true)
  {
    //if user select delete appointment,
	...
	echo($stds[0]);
            ...
            if($stds)
	    {
	      ...
	      //fetches data from the appointment time and student information
	      // removes the specific row with corresponding student ID
	    ...
	    //removes the time from current timeslot
	    ...
	    //display the student information that belongs in the group appointment
	    ...
	    //displays information about group advising
            echo("Number of students enrolled: $row[2]<br>");
            echo("Student limit: $row[3]");

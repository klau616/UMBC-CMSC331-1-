        ...
        <div class="top">
          ...
          <?php
            ...
            parse_str($ind);
               ...
               //select data from project 2 advisor table
            ...
            if($row[4]){
	      //if there is data present on row 4 of the advisor table, it will continue on the next standment
             ...
             //deletes current item and enrolled ID from the appointment table 
            ...
            echo("Enrolled: ");
            if($row[4]){
	      //update student's status to C where its been changed
              echo("$std</b>");

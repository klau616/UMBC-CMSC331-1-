...
<form action="AdminProcessCreateNew.php" method="post" name="Create">
    ...
    <!-- This section obtains desire information from user to create new user and record it in database-->
    ...
    <!-- klau4 10/20/2015-->
    <!-- added office location prompt-->

    <div class="field">
    <label for="Office">Office Number</label>
    <input id="Office" size"=20" maxlength="50" type="text" name="Office" reqiuired>
    </div>

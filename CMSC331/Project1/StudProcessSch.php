...
if($_POST["finish"] == 'Cancel'){
	...
	{ 
	  //added code here
	  $sql = "select * from Proj2Appointments where `Time` = '$apptime' and `AdvisorID` = '$advisor'";
	  $rs = $COMMON->executeQuery($sql, $_SERVER["SCRIPT_NAME"]);
	  ...
	  //took out the line below
	  //	  $rs = $COMMON->executeQurery($sql, $_SERVER["SCRIPT_NAME"]);
